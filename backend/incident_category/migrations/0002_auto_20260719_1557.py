...
def seed_categories(apps, schema_editor):
    IncidentCategory = apps.get_model(
        'incident_category',
        'IncidentCategory'
    )
    SubCategory = apps.get_model(
        'incident_category',
        'SubCategory'
    )
    ...
    data = {
        ...
        "Electrical & Electronics": [
            "Solar Panel Installer", "CCTV Installer",
        ...
        "Fashion & Beauty": [
            ...
            "Embroiderer", "Cobbler (Shoemaker)",
            "Leather Worker", "Barber", "Hairdresser",
